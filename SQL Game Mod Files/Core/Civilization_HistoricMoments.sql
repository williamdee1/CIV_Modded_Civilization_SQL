...
-- Please note: For the below code to be used, Rise & Fall (Expansion1) is required. However, this file has been configured to only execute if Rise & Fall (Expansion1) is detected and active. As such, this allows for its inclusion without creating a full dependency on the expansion. This is done by setting the appropriate Criteria within the Update Database In-Game Action that processes the contents of this file.
-----------------------------------------------
INSERT INTO MomentIllustrations
		(MomentIllustrationType,					MomentDataType,					GameDataType,						Texture)
VALUES	('MOMENT_ILLUSTRATION_UNIQUE_UNIT',			'MOMENT_DATA_UNIT',				'UNIT_WEREJAGUAR',					'WerejaguarHistoricMoment.dds'),
