...
-- You'll note that the ICON_ATLAS_MC_OLMEC has one 'different' icon - the OlmecColourAtlas45.dds. This is a full-colour icon, 45x45 pixels in size, that is used in certain parts of the UI. All other icons in the ICON_ATLAS_MC_OLMEC atlas are single-colour (white) and transparent - as the game replaces the 'white' with the PRIMARY colour(s) defined in Civilization_Colors.sql. Transparent areas are replaced with the SECONDARY colour(s) defined in the same place (in the remaining portion of the circular badge).

-- A quick note on the ICON_ATLAS_WEREJAGUAR atlas. I've left this in here, configured in this way, to illustrate how to use multi-icon atlases. In this example, each WerejaguarAtlasXXX.dds file has two icons - the Unique Unit icon and Unique Unit portrait. We'll describe further down how we differentiate to the game which should be used for which function through the IconDefinitions section.
...
VALUES	('ICON_ATLAS_MC_OLMEC',					45,	 		1,				1,					'OlmecColourAtlas45.dds'	),

		('ICON_ATLAS_MC_OLMEC',					22,	 		1,				1,					'OlmecAtlas22.dds'			),
		...
		('ICON_ATLAS_WEREJAGUAR',				256,		2,				1,					'WerejaguarAtlas256.dds'	),
		('ICON_ATLAS_WEREJAGUAR',				200,		2,				1,					'WerejaguarAtlas200.dds'	),
		('ICON_ATLAS_WEREJAGUAR',				95,			2,				1,					'WerejaguarAtlas95.dds'		),
		('ICON_ATLAS_WEREJAGUAR',				80,			2,				1,					'WerejaguarAtlas80.dds'		),
		('ICON_ATLAS_WEREJAGUAR',				70,			2,				1,					'WerejaguarAtlas70.dds'		),
		('ICON_ATLAS_WEREJAGUAR',				50,			2,				1,					'WerejaguarAtlas50.dds'		),
		('ICON_ATLAS_WEREJAGUAR',				38,			2,				1,					'WerejaguarAtlas38.dds'		),
		('ICON_ATLAS_WEREJAGUAR',				32,			2,				1,					'WerejaguarAtlas32.dds'		),
		('ICON_ATLAS_WEREJAGUAR',				22,			2,				1,					'WerejaguarAtlas22.dds'		),
...
VALUES	('ICON_CIVILIZATION_MC_OLMEC',				'ICON_ATLAS_MC_OLMEC',			0					),
		...
		('ICON_UNIT_WEREJAGUAR_PORTRAIT',			'ICON_ATLAS_WEREJAGUAR',		0					),
		('ICON_UNIT_WEREJAGUAR',					'ICON_ATLAS_WEREJAGUAR',		1					);