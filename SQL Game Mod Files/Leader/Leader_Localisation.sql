...
-----------------------------------------------	
	...
	('en_US',	'LOC_LEADER_MC_PO_NGBE_NAME',  'Tom Dee'	),
	
-----------------------------------------------
-- UA
-----------------------------------------------	

	('en_US',	'LOC_TRAIT_LEADER_FEAR_NOT_EXPLORATION_NAME',  'Wholesome Outdoors Stamina'	),
	('en_US',	'LOC_TRAIT_LEADER_FEAR_NOT_EXPLORATION_DESCRIPTION',	'Brawlers, Builders and Settlers ignore movement penalties in Hills terrain.'	),
...
-----------------------------------------------	
	...
	'Tom Dee, King of the Beards! You shall lead the mighty homebrewers out in search of new flavours, interesting textures and a high rating on Untappd. With your new homebrewing techniques you will challenge conventional beer-making and lay seige to tasteless lagers.'  	),
