...
-- InheritFrom: I am not aware of the function here - I have left this as-is (from another template) and note that all base-game leaders have this value set.
-- SceneLayers: Similar to the above, this matches the other base-game leaders. I am not aware of the repercussions of changing this value.
-----------------------------------------------
...
-- However, I have left this here to illustrate how variations can be achieved on a per-leader basis within a civilization. This can be used for flavour - however, all CityName values should be defined within this mod.
-----------------------------------------------
